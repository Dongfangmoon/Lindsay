...
const articleUpdate = async (clickState) => {
    ...
    ElMessage.success(result.msg ? result.msg : '修改文章成功');
    // 让抽屉消失
    visibleDrawer.value = false;
    // 刷新文章列表
    articleList();
            ...
            <el-form :model="articleModel" label-width="100px">
                ...
                <el-form-item>
                    <el-button type="primary"
                        @click="title === '添加文章' ? articleAdd('已发布') : articleUpdate('已发布')">发布</el-button>
                    <el-button type="info"
                        @click="title === '添加文章' ? articleAdd('草稿') : articleUpdate('草稿')">草稿</el-button>
                </el-form-item>
            </el-form>
        </el-drawer>
    </el-card>
